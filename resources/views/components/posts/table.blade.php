@if (session('success'))
    <div id="toast-success-wrapper"
        class="absolute top-12 right-0 z-50 flex items-end justify-end p-4 sm:items-start sm:p-6">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <dl>
                ...
                <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">Standard glass ,3.8GHz
                    ...
                    Radeon Pro 5500 XT with 8GB of GDDR6 memory, 256GB SSD storage, Gigabit Ethernet, Magic
                    Mouse 2,
